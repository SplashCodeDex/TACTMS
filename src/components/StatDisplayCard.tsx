...
const StatDisplayCard: React.FC<StatDisplayCardProps> = ({
  ...
  return (
    <div
      className="flex items-center p-4 rounded-xl shadow-lg transition-all duration-300 ease-in-out bg-[var(--bg-card-subtle-accent)] border border-[var(--border-color)] card-glow-on-hover"
      role="group"
