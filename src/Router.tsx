...
const MemberDatabaseSection = React.lazy(() => import('./components/MemberDatabaseSection'));
const ListOverviewActionsSection = React.lazy(() => import('./sections/ListOverviewActionsSection'));
const ConfigurationSection = React.lazy(() => import('./sections/ConfigurationSection'));
