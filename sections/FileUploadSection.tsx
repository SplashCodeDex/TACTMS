        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          <div className="space-y-4">
            ...
            <p className="text-sm text-[var(--text-secondary)] -mt-3">
              Quickly start your weekly data entry by loading the latest tithe
              list for an assembly.
            </p>
            <div className="flex items-end gap-3">
              ...
              <Button
                ...
                disabled={!selectedAssemblyForStart}
            ...
            {favorites.length === 0 && (
              <p className="text-xs text-[var(--text-muted)]">
                Save a list to favorites to enable this feature.
              </p>
            )}
          </div>
          <div className="space-y-4 border-t md:border-t-0 md:border-l border-[var(--border-color)] pt-8 md:pt-0 md:pl-8">
            ...
            <p className="text-sm text-[var(--text-secondary)] -mt-3">
              Upload a file to start a new weekly list or update a master list
              in the database.
            </p>
            <FileUploader
              onFileAccepted={(file) => onFileAccepted(file, false)}
            />
          </div>
        </div>
      </section>
