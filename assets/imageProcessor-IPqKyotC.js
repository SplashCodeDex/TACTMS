import{G as E,t as o}from"./index-Hzz40tgP.js";const A="gemini-3-pro-image-preview",N={type:o.ARRAY,items:{type:o.OBJECT,properties:{"No.":{type:o.NUMBER,description:"The sequential number from the book row."},Name:{type:o.STRING,description:"The full name of the tither as written."},Amount:{type:o.NUMBER,description:"The specific amount recorded in the target month/week column. Use 0 if the cell is blank."},Confidence:{type:o.NUMBER,description:"A score from 0.0 to 1.0 indicating confidence in the legibility and extraction of this row."}},required:["No.","Name","Amount","Confidence"]}},C=async(a,i,t,e,s)=>{var p;if(!i)throw new Error("API Key is missing");if((!t||!e||!s)&&(t||e))throw new Error("Month, Week, and Date are required for a focused extraction.");const f=new E(i).getGenerativeModel({model:A}),y=await I(a),w=`
