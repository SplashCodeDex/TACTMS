...
> = ({
    ...
    if (isCollapsed) {
      return (
        <div className="flex flex-col items-center gap-3">
          <div
            className="w-10 h-10 flex items-center justify-center bg-[var(--bg-card)] rounded-lg"
  ...
  const SyncStatusIcon = () => {
    switch (syncStatus) {
      ...
      case "synced":
        return <CloudCheck size={16} className="text-[var(--success-text)]" />;
      case "error":
        return <AlertCircle size={16} className="text-[var(--danger-text)]" />;
      default:
        return <Cloud size={16} className="text-[var(--text-muted)]" />;
    }
  };
      ...
      return (
        <div className="flex flex-col items-center gap-3">
          <img
            ...
            title={`${userProfile.name} - ${syncStatusText[syncStatus]}`}
          />
          <Button
            onClick={signOut}
            size="icon"
...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  const logoSrc = isCollapsed
    ? theme === "dark"
      ? "./img/TAC-Dexify-for-dark-bg-only-logo-01.svg"
      : "./img/TAC-Dexify-for-light-bg-only-logo.svg"
    : theme === "dark"
      ? "./img/TAC-Dexify-only-logo-darkmode-01.svg"
      : "./img/TAC-Dexify-only-logo-lightmode-01.svg";
